...
function CloseButton() {
  return (
    <button className="btn btn-square col-start-5" onClick={handleExit}>
...
function MinimiseButton() {
  return (
    <button className="btn btn-square col-start-4" onClick={handleMinimise}>
...
function HomeButton() {
  return (
    <button className="btn btn-square col-start-3" onClick={handleHome}>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-6 h-6">
